      ...
      <div className="w-full  h-auto flex justify-center items-center flex-col ">
        <div className="relative w-auto h-auto flex flex-col mb-[18px]">
          <Image
            src={destaque}
            alt="rabisco"
            className="absolute top-[-1.5rem] left-[-3.5rem] best"
          />
        ...
        <div className="w-auto  h-auto flex flex-col justify-center items-center relative mb-[102px] ">
          <p className="inter text-[#AEABAB] text-[14px] font-normal text-left w-[522px] mb-[72px] ml-[170px] leading-[26px]">
            O Núcleo Tecnológico do CAF, também conhecido como Núcleo de Jovens
            Inventores/Inovadores do CAF, é um grupo acadêmico sem fins
        ...
        <div className="w-auto h-auto  flex justify-center space-x-[-95px] items-center relative ">
          <Image src={img3} alt="..." />
          <Image src={img3} alt="..." />
